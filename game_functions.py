...
def fire_bullet(game_settings, screen, ship, bullets):  # fire a bullet if limit not reached
...
def update_bullets(game_settings, screen, stats, sb, ship, aliens, bullets):  # update position of bullets and get rid of old bullets
...
def check_bullet_alien_collisions(game_settings, screen, stats, sb, ship, aliens, bullets):
    # check for any bullets that have hit aliens, if get rid of bullets and alien
...
def get_number_aliens_x(game_settings, alien_width):
    # create a number of aliens that fit in a row
...
def create_fleet(game_settings, screen, ship, aliens):  # create a full fleet of aliens
...
def update_aliens(game_settings, stats, sb, screen, ship, aliens, bullets):  # update the positions of all aliens in the fleet
...
def check_fleet_edges(game_settings, aliens):  # respond appropriately if any aliens have reached an edge
